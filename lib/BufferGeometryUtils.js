...
THREE.BufferGeometryUtils = {
	...
	computeTangents: function ( geometry ) {
		...
		if ( attributes.tangent === undefined ) {
			...
			geometry.setAttribute( 'bitangent', new THREE.BufferAttribute( new Float32Array( 4 * nVertices ), 4 ) );

		}

		var tangents = attributes.tangent.array;
		var bitangents = attributes.bitangent.array;
		...
		function handleVertex( v ) {
			...
			bitangents[ v * 4 ] = tmp.x;
			bitangents[ v * 4 + 1 ] = tmp.y;
			bitangents[ v * 4 + 2 ] = tmp.z;
			bitangents[ v * 4 + 3 ] = w;
		}
